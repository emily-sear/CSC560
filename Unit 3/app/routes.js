...
var userSchema = new mongoose.Schema({
    ...
    spi_api_key_secret : {type:String, trim: true},
...
// create indexes in ascending order 
...
// create indexes for feed schema in ascending order 
...
// create a compound index on all four fields 
